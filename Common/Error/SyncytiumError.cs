...
namespace Syncytium.NetCore.Common.Error
{
    ...
    public class SyncytiumError
    {
        ...
        public JObject ToJSON()
        {
            ...
            if (Parameters != null)
                error[nameof(Parameters)] = new JArray(Parameters);
            else
                error[nameof(Parameters)] = new JArray();
        ...
        public SyncytiumError(string message, params object[] parameters)
        {
            Message = message;
